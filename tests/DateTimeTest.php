...
use \Messier\Date\DateTime;
use \Messier\Date\Time;
...
class DateTimeTest extends PHPUnit_Framework_TestCase
{
   ...
   public function setUp()
   {
      if ( ! ( $this->dt instanceof DateTime ) )
      {
         ...
         Locale::Create( new Locale( 'de', 'DE', 'UTF-8' ) )->registerAsGlobalInstance();
      }
   ...
   {
      $this->assertSame( 0, $this->dt->getAge(), 'getAge 1' );
      $this->assertSame( 74, $this->dt2->getAge(), 'getAge 2' );
   }
   /**
    * @covers \Messier\Date\DateTime::__get
    */
   public function testDynamicProperties()
   {
      ...
      $this->assertFalse( $this->dt2->foo, 'foo' );
   }
   ...
   public function testFormat()
   {
      ...
      $this->assertSame(
         ...
         $this->dt->format( \Messier\Date\DateTimeFormat::ATOM ),
         'format 1'
      );
      $this->assertSame(
         'Friday, 24-Jun-2016 13:15:00 CEST',
         $this->dt->format( \Messier\Date\DateTimeFormat::COOKIE ),
         'format 2'
      );
      $this->assertSame(
         '2016-06-24',
         $this->dt->format( \Messier\Date\DateTimeFormat::DATE ),
         'format 3'
      );
      $this->assertSame(
         '2016-06-24T13:15:00+0200',
         $this->dt->format( \Messier\Date\DateTimeFormat::ISO8601 ),
         'format 4'
      );
      $this->assertSame(
         'Fri, 24 Jun 16 13:15:00 +0200',
         $this->dt->format( \Messier\Date\DateTimeFormat::RFC822 ),
         'format 5'
      );
      $this->assertSame(
         'Friday, 24-Jun-16 13:15:00 CEST',
         $this->dt->format( \Messier\Date\DateTimeFormat::RFC850 ),
         'format 6'
      );
      $this->assertSame(
         'Fri, 24 Jun 16 13:15:00 +0200',
         $this->dt->format( \Messier\Date\DateTimeFormat::RFC1036 ),
         'format 7'
      );
      $this->assertSame(
         'Fri, 24 Jun 2016 13:15:00 +0200',
         $this->dt->format( \Messier\Date\DateTimeFormat::RFC2822 ),
         'format 8'
      );
      $this->assertSame(
         '2016-06-24T13:15:00+02:00',
         $this->dt->format( \Messier\Date\DateTimeFormat::RFC3339 ),
         'format 9'
      );
      $this->assertSame(
         '2016-06-24 13:15:00',
         $this->dt->format( \Messier\Date\DateTimeFormat::SQL ),
         'format 10'
      );
      $this->assertSame(
         '2016-06-24',
         $this->dt->format( \Messier\Date\DateTimeFormat::SQL_DATE ),
         'format 11'
      );
      $this->assertSame(
         '13:15:00',
         $this->dt->format( \Messier\Date\DateTimeFormat::SQL_TIME ),
         'format 12'
      );
      $this->assertSame(
         '2016-06-24 13:15:00 CEST',
         $this->dt->format( \Messier\Date\DateTimeFormat::SQL_TZ ),
         'format 13'
      );
      $this->assertSame(
         'Fri, 24 Jun 2016 13:15:00 +0200',
         $this->dt->format( \Messier\Date\DateTimeFormat::RSS ),
         'format 14'
      );
      $this->assertSame(
         '2016-06-24T13:15:00+02:00',
         $this->dt->format( \Messier\Date\DateTimeFormat::W3C ),
         'format 15'
      );
      $this->assertSame(
         '13:15:00',
         $this->dt->format( \Messier\Date\DateTimeFormat::TIME ),
         'format 16'
      );
   }
   ...
   public function testOther()
   {
      ...
      $this->assertFalse(
         ...
         'Parse 6' );
      $this->assertFalse(
         DateTime::Parse( new \Messier\Type( false ) ),
         'Parse 7' );
      $cls = new stdClass();
      $cls->foo = 20;
      $this->assertFalse(
